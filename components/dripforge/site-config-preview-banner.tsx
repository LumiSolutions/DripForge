...
export function SiteConfigPreviewBanner() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 top-0 z-[300] flex justify-center px-4 pt-[max(0.5rem,env(safe-area-inset-top))]">
      <div className="pointer-events-auto flex max-w-3xl flex-wrap items-center justify-center gap-3 rounded-xl border border-amber-500/40 bg-amber-500/95 px-4 py-2 text-sm font-medium text-amber-950 shadow-lg backdrop-blur-sm">
